...
import { QuestionEditorChoiceOptions } from "./question-editor-choice-options";
import { QuestionEditorFollowUpRules } from "./question-editor-follow-up-rules";
  ...
  return (
    <Card className="border-primary/15">
      ...
      <CardContent className="space-y-4">
        ...
        <QuestionEditorFollowUpRules
          question={props.question}
          section={props.section}
          questionByClientId={props.questionByClientId}
          onAddFollowUpQuestion={props.onAddFollowUpQuestion}
          onAddNestedFollowUpQuestion={props.onAddNestedFollowUpQuestion}
